                        ...
                        <div class="d-flex gap-4 mb-4 flex-column" style="width: 80%">
                            ...
                            <div class="d-flex flex-row flex-wrap gap-3">
                                <div class="container-login100-form-btn" style="width: 40%">
                                    <button id="pengguna" class="login100-form-btn rounded-4" style="font-weight: bolder">
                                        <span>
                                            <svg class="mt-2" width="38" height="30" viewBox="0 0 40 38"
                                ...
                                <div class="container-login100-form-btn" style="width: 40%">
                                    <button id="button" class="login100-form-btn d-flex gap-3 rounded-4"
                                        style="font-weight: bolder">
                                        <span>
                                            <svg class="mt-2" width="30" height="22" viewBox="0 0 28 22"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
