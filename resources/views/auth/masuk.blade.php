...
@section('content')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const dataKey = 'dataKey'; // Ganti dengan kunci yang sesuai dengan data Anda
            const checkbox = document.querySelector('#ckb1');
            const setujuButton = document.querySelector('#setujuButton');

            // Coba mengambil data dari Local Storage
            ...
            window.addEventListener('unload', function() {
                // Ganti 'dataKey' dengan kunci yang sesuai
