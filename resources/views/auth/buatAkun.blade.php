            ...
            <div class="wrap-login100" class="d-flex  flex-column">
                <div class="d-flex">
                    <form class="login100-form validate-form">
                        ...
                        <div class="mb-3">
                            <input placeholder="Email" type="email" class="form-control rounded-3" id="exampleInputEmail1"
                        ...
                        <div class="flex-sb-m w-full p-t-3 p-b-32">
                            <div style="color: black; font-weight: 600; font-size: 13px">
                                <span>sudah punya akun? klik <a href=""
