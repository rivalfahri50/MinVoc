        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-md-7 grid-margin stretch-card">
                    ...
                    <div style="background-color: #ececec" class="card datakanan scrollbar-dusty-grass square thin rounded-4">
                ...
                <div class="col-md-5 grid-margin stretch-card">
                    ...
                    <div class="card datakiri scrollbar-dusty-grass square thin rounded-4">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
