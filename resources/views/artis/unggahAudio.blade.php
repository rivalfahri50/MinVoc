...
@section('content')
    <div class="main-panel">
        <div class="content-wrapper">
            <form class="row" action="{{ route('unggah.artis') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col d-flex flex-row gap-4">
                    <label for="tamel" style="cursor: pointer"
                        class="card col-md-2 d-flex justify-content-center align-items-center">
                        ...
                        <input type="file" class="d-none" id="tamel" name="image" value="{{ old('image') }}" />
                    </label>
                    @error('image')
            ...
            <div class="row mt-4">
                <div class="col-12 grid-margin">
                    <div class="p-2">
                        <ul class="list-group">
                            <li class="list-group-item text-white  d-flex flex-row justify-content-between"
                                style="background-color: #957DAD; font-weight: bolder; border-radius: 20px;">
