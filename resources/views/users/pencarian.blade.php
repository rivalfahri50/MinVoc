                ...
                <div class="col-md-12 grid-margin stretch-card">
                    ...
                    <div class="cards">
                        <a href="kategori/pop.html" class="card card-scroll coba">
                            <img src="/user/assets/images/faces/face11.jpg" style="border-radius: 15px"
                                class="img-fluid rounded-4 try">
                        </a>
                        <a href="#" class="card card-scroll">
                            <img src="/user/assets/images/faces/face1.jpg" style="border-radius: 15px"
                                class="img-fluid rounded-4 try">
                        </a>
                        <a href="#" class="card card-scroll">
                            <img src="/user/assets/images/faces/face1.jpg" style="border-radius: 15px"
