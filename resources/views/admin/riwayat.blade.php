...
<link rel="stylesheet" href="/admin/assets/css/riwayat.css">
       ...
       <div class="main-panel">
        <div class="content-wrapper">
            <h3 class="judul mb-4">Riwayat Persetujuan Unggah Lagu</h3>
            <div class="row">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="row">
                        <div class="col-4">
                            <div class="dropdown">
                                <button class="btn dropdown-toggle full-width-btn" type="button"
                                    id="tanggalDropdown" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                    Tanggal
                                </button>
                        ...
                        <div class="col-4">
                            <div class="dropdown">
                                <button class="btn dropdown-toggle full-width-btn" type="button"
                                    id="bulanDropdown" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                    Bulan
                                </button>
                                <div class="dropdown-menu dropdown-menu-scroll scrollbar-down"
                        ...
                        <div class="col-4">
                            <div class="dropdown">
                                <button class="btn dropdown-toggle full-width-btn" type="button"
                                    id="tahunDropdown" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                    Tahun
                                </button>
                                <div class="dropdown-menu dropdown-menu-scroll scrollbar-down"
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr class="table-row">
                                    ...
                                    <td class="table-cell">18/12/2023</td>
...
$(document).ready(function () {
    ...
    var tanggalOptions = Array.from({ length: 31 }, (_, i) => (i + 1).toString());
    ...
    var tahunOptions = Array.from({ length: tahunSekarang - 1999 }, (_, i) => (2000 + i).toString());
