        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-md-7 grid-margin stretch-card">
                    <div class="card border-0" style="background-color: #6c6c6c">
                        <img src="assets/images/dashboard/img_1.jpg" class="img-billboard img-fluid" alt="Forest"
                            style="height: 30vh" />
                    ...
                    <h3 class="card-title py-2 fw-semibold">
                        Lagu yang disarankan
                    </h3>
                    <div style="background-color: #ececec" class="card datakanan scrollbar-dusty-grass square thin">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="preview-list" style="color: #6c6c6c">
                                        <div class="preview-item" style="width: 100%">
                                            ...
                                            <div class="preview-item-content d-sm-flex flex-grow">
                                                ...
                                                <div
                                                    class="mr-auto text-sm-right pt-2 pt-sm-0 d-flex justify-content-center align-items-center gap-3">
                                                    <span><svg width="19" height="17" viewBox="0 0 19 17"
                                    ...
                                    <div class="preview-list">
                                        <div class="preview-item">
                                            ...
                                            <div class="preview-item-content d-sm-flex flex-grow">
                                                ...
                                                <div
                                                    class="mr-auto text-sm-right pt-2 pt-sm-0 d-flex justify-content-center align-content-center">
                                                    <span><svg width="19" height="17" viewBox="0 0 19 17"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                                                d="M9.5 2.03326L8.914 1.45614C7.91483 0.510073 6.58664 -0.00866788 5.21159 0.0101114C3.83654 0.0288906 2.52297 0.583711 1.54995 1.55671C0.576925 2.5297 0.0211134 3.84421 0.0005892 5.22096C-0.019935 6.59772 0.496446 7.92825 1.44003 8.92989L9.5 17L17.56 8.92027C18.5036 7.91863 19.0199 6.5881 18.9994 5.21135C18.9789 3.83459 18.4231 2.52009 17.4501 1.54709C16.477 0.574092 15.1635 0.0192719 13.7884 0.000492655C12.4134 -0.0182866 11.0852 0.500455 10.086 1.44652L9.5 2.03326Z"
