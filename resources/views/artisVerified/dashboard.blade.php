        ...
        function redirectArtis(id) {
            $.ajax({
                ...
                success: function(response) {
                    window.location.href = /pengguna/detail - artis / $ {
                        id
                    };
                },
            });
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    response.forEach(function(item) {
                        ...
                        const like = document.getElementById(like - atas$ {
                            item.song_id
                        });
        ...
        $(document).ready(function() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    response.forEach(function(item) {
                        const songId = item.song_id;
                        const like = document.getElementById(like - bawah$ {
                            item.song_id
                        });
                        if (like) {
                            like.classList.toggle('fas');
