...
@section('content')
<link rel="stylesheet" href="/user/assets/css/pencarian.css">
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12 grid-margin stretch-card">
                            <h3 class="judul" style="font-size: 20px; font-weight: 600">Kategory</h3>
                            <div class="cards">
                                <a href="kategori/pop.html" class="card card-scroll coba">
                                    <img src="/user/assets/images/faces/face11.jpg" style="border-radius: 15px" class="img-fluid rounded-4 try">
                                </a>
                                <a href="#" class="card card-scroll">
                                    <img src="/user/assets/images/faces/face1.jpg"  style="border-radius: 15px"  class="img-fluid rounded-4 try">
                                </a>
                                <a href="#" class="card card-scroll">
                                    <img src="/user/assets/images/faces/face1.jpg" style="border-radius: 15px"  class="img-fluid rounded-4 try">
                                </a>
                                ...
                                <a href="#" class="card card-scroll">
                                    <img src="/user/assets/images/faces/face1.jpg" style="border-radius: 15px"  class="img-fluid rounded-4">
                                </a>
                            </div>
                        </div>
                        <div class="col-md-8 grid-margin stretch-card">
                            <h3 class="card-title mb-4 judul" style="font-size: 20px; font-weight: 600">Lagu populer</h3>
                        ...
                        <div class="col-md-4 grid-margin stretch-card">
                            <h3 class="card-title mb-4 judul" style="font-size: 20px; font-weight: 600">Penyanyi populer</h3>
                            <div class="card scroll scrollbar-down thin">
                                <div class="card-body">
